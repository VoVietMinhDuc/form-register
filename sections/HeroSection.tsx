...
export function HeroSection() {
  return (
    <section
      ...
      className="phoenix-section relative isolate min-h-[70vh] md:min-h-[90vh] overflow-hidden rounded-[32px] bg-[#090909] px-6 py-12 md:py-16 md:px-12"
    >
      <BackgroundGrid />
      ...
      >
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-[24px] md:rounded-[48px] border border-white/15 bg-black/40 p-3 md:p-5 shadow-[0_35px_120px_rgba(255,50,0,0.45)]"
        >
          <div className="absolute inset-0 -z-10 bg-gradient-to-br from-[#ff0000]/50 via-transparent to-[#ff4500]/25 blur-[110px]" />
          <div className="relative overflow-hidden rounded-[16px] md:rounded-[32px] bg-black">
            <Image
              src="https://res.cloudinary.com/dmgq6kgdt/image/upload/v1764140451/phoenix_igpyra.jpg"
              alt="Phoenix House Illustration"
              width={1400}
              height={800}
              className="h-auto sm:h-[380px] md:h-[480px] lg:h-[560px] w-full rounded-[16px] md:rounded-[32px] object-contain sm:object-cover object-center"
              priority
              sizes="(max-width: 640px) 100vw, (max-width: 768px) 90vw, (max-width: 1024px) 80vw, 1200px"
            />
            {/* Hiệu ứng lóa kính chạy từ trái sang phải */}
            <div className="absolute inset-0 rounded-[16px] md:rounded-[32px] overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-4 left-4 md:bottom-8 md:left-8 rounded-full border border-white/20 bg-black/60 px-3 py-1.5 md:px-4 md:py-2 text-[10px] md:text-xs uppercase tracking-[0.3em] md:tracking-[0.4em] text-white/80 backdrop-blur">
            Phoenix House
          </div>
        </motion.div>
      </motion.div>
